 ...
 public void currentDate (){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          String sql = "select id, username, password, division from info Where (username =? and password =? and division =?)";
           ...
           if(access=="Admin") {
               ...
               if(count==1){
                  ...
                  String values = dateString;
                   ...
                   int value = Emp.empId;
                   String reg = "insert into info (emp_id,date,status) values ('"+value+"','"+value0+" / "+values+"','Logged in')";
